  ...
  CreateClasses(
    {
      ...
      bg:
        "after:focus-visible:bg-primary-light after:focus-visible:dark:bg-primary-dark after:focus-visible:opacity-focus",
    },
    user_classes,
  );
...
const Bubble = ({ width, height }: { width: number; height: number }) => {
  return (
    <span
      style={{ width, height }}
      className="animate-pulsing rounded-full bg-light-focus-primary dark:bg-dark-focus-primary"
    >
    </span>
  );
};
