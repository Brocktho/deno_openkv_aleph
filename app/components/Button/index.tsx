...
export const TextButtonClsxs: ClassOptions = {
  ...
  disabled: "text-on-surface-light dark:text-on-surface-dark opacity-disabled",
  hover:
    "before:hover:bg-primary-light before:dark:hover:bg-primary-dark before:hover:opacity-hover",
  focus_visible:
  ...
  active:
    "before:active:bg-primary-light before:dark:active:bg-primary-dark before:active:opacity-active",
};
...
export const ElevatedButtonClsxs: ClassOptions = {
  ...
  hover:
    "before:hover:bg-primary-light before:dark:hover:bg-primary-dark before:hover:opacity-hover before:hover:shadow-md",
  focus_visible:
    "focus-visible:outline-none before:focus-visible:bg-primary-light before:dark:focus-visible:bg-primary-dark before:focus-visible:opacity-focus",
  active:
    "before:active:bg-primary-light before:dark:active:bg-primary-dark before:active:opacity-active before:active:shadow",
};
...
export const FilledButtonClsxs: ClassOptions = {
  ...
  hover:
    "before:hover:bg-on-primary-light before:dark:hover:bg-on-primary-dark before:hover:shadow before:hover:opacity-hover",
  focus_visible:
  ...
  active:
    "before:active:bg-on-primary-light before:dark:active:bg-on-primary-dark before:active:shadow-sm before:active:opacity-active",
};
...
export const TonalButtonClsxs: ClassOptions = {
  ...
  disabled:
    "bg-transparent before:bg-on-surface-light before:dark:bg-on-surface-dark text-on-surface-light dark:text-on-surface-dark opacity-disabled before:opacity-active",
  hover:
    "before:hover:bg-on-secondary-container-light before:dark:hover:bg-on-secondary-container-dark before:hover:shadow before:hover:opacity-hover",
  focus_visible:
  ...
  active:
    "before:active:bg-on-secondary-container-light before:dark:active:bg-on-secondary-container-dark before:active:shadow-sm before:active:opacity-active",
};
