  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "neutral-variant0": "hsl(var(--md-ref-palette-neutral-variant0) / 1)",
        "neutral-variant10": "hsl(var(--md-ref-palette-neutral-variant10) / 1)",
        "neutral-variant20": "hsl(var(--md-ref-palette-neutral-variant20) / 1)",
        "neutral-variant30": "hsl(var(--md-ref-palette-neutral-variant30) / 1)",
        "neutral-variant40": "hsl(var(--md-ref-palette-neutral-variant40) / 1)",
        "neutral-variant50": "hsl(var(--md-ref-palette-neutral-variant50) / 1)",
        "neutral-variant60": "hsl(var(--md-ref-palette-neutral-variant60) / 1)",
        "neutral-variant70": "hsl(var(--md-ref-palette-neutral-variant70) / 1)",
        "neutral-variant80": "hsl(var(--md-ref-palette-neutral-variant80) / 1)",
        "neutral-variant90": "hsl(var(--md-ref-palette-neutral-variant90) / 1)",
        "neutral-variant95": "hsl(var(--md-ref-palette-neutral-variant95) / 1)",
        "neutral-variant99": "hsl(var(--md-ref-palette-neutral-variant99) / 1)",
        "neutral-variant100":
          "hsl(var(--md-ref-palette-neutral-variant100) / 1)",
        "primary-light": "hsl(var(--md-sys-color-primary-light) / 1)",
        "on-primary-light": "hsl(var(--md-sys-color-on-primary-light) / 1)",
        ...
        "secondary-light": "hsl(var(--md-sys-color-secondary-light) / 1)",
        "on-secondary-light": "hsl(var(--md-sys-color-on-secondary-light) / 1)",
        ...
        "on-tertiary-light": "hsl(var(--md-sys-color-on-tertiary-light) / 1)",
        ...
        "background-light": "hsl(var(--md-sys-color-background-light) / 1)",
        "on-background-light":
          "hsl(var(--md-sys-color-on-background-light) / 1)",
        "surface-light": "hsl(var(--md-sys-color-surface-light) / 1)",
        "on-surface-light": "hsl(var(--md-sys-color-on-surface-light) / 1)",
        ...
        "surface-tint-light": "hsl(var(--md-sys-color-surface-tint-light) / 1)",
        ...
        "on-primary-dark": "hsl(var(--md-sys-color-on-primary-dark) / 1)",
        ...
        "on-secondary-dark": "hsl(var(--md-sys-color-on-secondary-dark) / 1)",
        ...
        "on-tertiary-dark": "hsl(var(--md-sys-color-on-tertiary-dark) / 1)",
        ...
        "background-dark": "hsl(var(--md-sys-color-background-dark) / 1)",
        "on-background-dark": "hsl(var(--md-sys-color-on-background-dark) / 1)",
        "surface-dark": "hsl(var(--md-sys-color-surface-dark) / 1)",
        "on-surface-dark": "hsl(var(--md-sys-color-on-surface-dark) / 1)",
        ...
        "surface-tint-dark": "hsl(var(--md-sys-color-surface-tint-dark) / 1)",
